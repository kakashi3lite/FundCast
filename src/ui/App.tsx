          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex items-center justify-between h-16">
              ...
              <div className="flex items-center space-x-2">
                ...
                <span className="text-white font-bold text-xl">FundCast</span>
              </div>
              ...
              <div className="flex items-center space-x-4">
                <button className="text-slate-300 hover:text-white px-4 py-2 text-sm font-medium">
                  Sign In
                </button>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
            <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
              ...
              <div>
                ...
                <ul className="space-y-2 text-sm">
                  <li><a href="#" className="text-slate-400 hover:text-white">Prediction Markets</a></li>
                  <li><a href="#" className="text-slate-400 hover:text-white">Founder Network</a></li>
                  <li><a href="#" className="text-slate-400 hover:text-white">Investment Tools</a></li>
                  <li><a href="#" className="text-slate-400 hover:text-white">AI Analytics</a></li>
                </ul>
              </div>
              ...
              <div>
                ...
                <ul className="space-y-2 text-sm">
                  ...
                  <li><a href="#" className="text-slate-400 hover:text-white">Compliance</a></li>
                  <li><a href="#" className="text-slate-400 hover:text-white">Risk Disclosure</a></li>
                </ul>
              </div>
            </div>
            ...
            <div className="border-t border-slate-800 mt-8 pt-8 text-center">
              <p className="text-slate-400 text-sm">
                © 2024 FundCast. All rights reserved. | SEC-compliant prediction markets for accredited investors.
              </p>
            </div>
          </div>
        </footer>
